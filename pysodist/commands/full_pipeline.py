...
def main(args):
    ...
    csv_list = run_isodist.run_fortran_isodist(in_file_list, isodist_command, threads=args.threads, wait_time=args.wait_time)
    ...
    try:
        ...
        print('...the output directory: ' + plot_output_folder + ' already exists, and files within it may be overwritten. continue? [y/n]')
        choice = input().lower()
        if not choice=='y':
            raise
    ...
    for protein in all_proteins:
        ...
        plot_spectra.plot_spectra_group(related_spectra, fit_folder, working_path=sample_output_directory, numerator=args.numerator, 
