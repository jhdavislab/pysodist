...
def add_args(parser):
    ...
    parser.add_argument('--wait_time', default=20, type=int,
    ...
    parser.add_argument('--logfile', default='pysodist.log', help='Optionally provide a logfile name.')
    return parser
...
def main(args):
    ...
    log('writing configuration file. 03_run_isodist.cfg'
        'Please check this file before proceeding to analyze_fits.')

    configure.write_config_file(config_data, '03_run_isodist.cfg', logfile)
