...
#                        help='Path to an optional configuration file (generated by pysodist config). '
#                             'If provided, the isodist_command, atomfile, resfile, resolution params will be ignored.')
