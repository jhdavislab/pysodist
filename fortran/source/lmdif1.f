...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
c       taken from fftpack5
c
c       only realy change is nprint value, set to print out every iteration
c
...
c
      ...
      xtol = tol
      gtol = zero
c     Changing epsfcn since offset did not change on 64 bit machines
c      epsfcn = zero
      epsfcn = 1.0e-3
      mode = 1


c       print out every iteration
      nprint = 1
