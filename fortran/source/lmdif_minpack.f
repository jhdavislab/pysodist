c       This is a subset of routines from minpack
c               for levenberg-marquardt least squares minimization
c               using a finite difference approximation
c
c       file contains:
...
c       fdjac2.f
c
c       These routines were obtained from netlib
c       http://www.netlib.org/minpack
c
c
